...
# 적
enemy = pygame.image.load("C:/Users/정지민/Desktop/python_project/python_project/pygame_basic/character.png")
enemy_size = character.get_rect().size
enemy_width = character_size[0]
enemy_high = character_size[1]
enemy_x_pos = (screen_width/2) - (character_width/2)
enemy_y_pos = screen_high - character_high
